...
from TAScheduler.models import User, TA, Administrator, Course, TAToCourse, Section, Lecture, Lab
from TAScheduler.views_methods import TAObj, AdminObj, CourseObj, LectureObj, LabObj
