...
class AdminGetAllSecAsgmt(TestCase):  # Kiran
    ...
    class TestInstructorAssignInstrLec(TestCase):  # Kiran
        ...
        def test_ExistLec(self):
            ...
            self.assertEqual(self.lecDBList[0].instructor, self.instrDB,
                             "Should have linked lec and instructor together")
    ...
    class TestCourseRemoveAssignment(TestCase):  # Randall
        ...
        def test_remove_assignment(self):
            ...
            self.assertTrue(self.ta_obj not in assignments or assignments is None,
                            "Tried to remove TA with no assignments")
