...
from TAScheduler.models import User, Administrator, Course, Section, TA, Lab, Instructor, InstructorToCourse, TAToCourse
from TAScheduler.views_methods import AdminObj, CourseObj, TAObj, LabObj, InstructorObj
